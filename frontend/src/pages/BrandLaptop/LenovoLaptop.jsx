...
function LenovoLaptop() {
    ...
    const {
        ...
        clearFilters,
    } = useProductFilter(lenovoProducts);
            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active"> Laptop Lenovo</li>
                    </ol>
                    </nav>
                    <h2 className="mb-3 fw-bold">Laptop Lenovo</h2>
